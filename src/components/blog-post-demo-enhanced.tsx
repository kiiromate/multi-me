...
import { ChartWrapper, InteractiveBarChart, InteractiveLineChart } from "./data-visualization/interactive-charts"

export default function BlogPostDemoEnhanced() {
...
const optimizeAnimation = () => {
  ...
  const performanceData = [
    { name: 'Before', lighthouse: 65, loadTime: 4.2 },
    { name: 'After Optimization', lighthouse: 95, loadTime: 1.8 },
    { name: 'With Animations', lighthouse: 92, loadTime: 2.1 },
    { name: 'Final Build', lighthouse: 96, loadTime: 1.6 },
  ]

  const userEngagementData = [
    { name: 'Week 1', bounceRate: 65, timeOnPage: 45 },
    { name: 'Week 2', bounceRate: 58, timeOnPage: 52 },
    { name: 'Week 3', bounceRate: 42, timeOnPage: 68 },
    { name: 'Week 4', bounceRate: 38, timeOnPage: 75 },
  ]
    ...
    >
      <div className="space-y-8">
        ...
        <section className="relative">
          ...
          <ChartWrapper title="Performance Optimization Journey">
            <InteractiveBarChart data={performanceData} />
          </ChartWrapper>
        ...
        <section className="relative">
          ...
          <ChartWrapper title="User Engagement Improvements">
            <InteractiveLineChart data={userEngagementData} />
          </ChartWrapper>
